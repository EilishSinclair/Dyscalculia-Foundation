...
var rootUrl = '/api/v1';
function getFruits() {
  return superagent__WEBPACK_IMPORTED_MODULE_0___default.a.get(rootUrl + '/fruits').then(function (res) {
...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      Object(_apiClient__WEBPACK_IMPORTED_MODULE_1__["getFruits"])().then(function (fruits) {
        _this2.setState({
          fruits: fruits
        });
      });
